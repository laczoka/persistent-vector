...
cljs.core.new_path_recur = function new_path_recur(b, c) {
  if(cljs.core.truth_(0 === b)) {
    return c
  }
  var d = cljs.core.aclone.call(null, cljs.core.PersistentVector.EMPTY_NODE);
  d[0] = new_path_recur.call(null, b - 5, c);
  return d
};
